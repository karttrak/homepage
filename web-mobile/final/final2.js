angular.module('mainApp', [])
	.service('classesService', function($http, $q) {
        ...
        $http.get("getClassList.php")
            .success(function(data) {
                ...
                $("#database").html(JSON.stringify(data));
                cList.resolve(data);
            });

        console.log('cList = ' + cList[0]);

		return {

			classList: cList.promise,
	...
	.controller('mainController', function($scope, classesService, $http) {

//        $scope.classList = classesService.classList.response;
        $scope.classList = [];
//        $scope.classList.push( getClassList() );
//        getClassList();
...
//			}
        ...
        function deleteClass(classTitle) {

            console.log('In deleteClass(). Deleting ' + classTitle);

            $http.post("deleteClass.php", { classTitle: classTitle})
//                { msg: $scope.username }
                .success(function(data) {

                    $scope.classList.push(data);
                    console.log(data);
